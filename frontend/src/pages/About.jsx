  ...
  return (
    <div className='aboutContainer'>
      <div className='header'>
        <Typography variant='h4' color='primary'>Introducción a PocketPal</Typography>
        <Typography variant='subtitle1' color='textSecondary'>Tu Billetera Virtual Todo en Uno</Typography>
      ...
      <div className='content'>
        <Typography variant='h5' color='primary'>¿Qué es PocketPal?</Typography>
        ...
        <Typography variant='h5' color='primary'>Características y Funcionalidades Principales</Typography>
        ...
        <Typography variant='h5' color='primary'>Conclusión</Typography>
