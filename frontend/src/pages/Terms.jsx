  ...
  return (
    <div className='termsContainer'>
      <div className='terms_title'>
        ...
        <Typography variant='body1'>Lea detenidamente los siguientes términos legales y condiciones de uso. Mediante la utilización de la página https://pocketpal-66fc9.web.app/ (en adelante el "Sitio"), usted presta conformidad y queda sujeto a todos los términos, condiciones y avisos que puedan encontrarse en estos Términos Legales y Condiciones de Uso.</Typography>
      </div>
