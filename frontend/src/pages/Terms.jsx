  ...
  return (
    <div className='termsContainer'>
      ...
      <div className='content'>
        <Typography variant='h5'>Uso de la Aplicación</Typography>
        <ul>
        ...
        <Typography variant='h5'>Registro y Cuentas de Usuario</Typography>
        <ul>
          <li>2.3. Eres responsable de proteger tu información de inicio de sesión y de mantenerla confidencial. Si sospechas que tu cuenta ha sido comprometida, debes informar de inmediato al equipo de soporte de PocketPal.</li>
          <li>2.4. Nos reservamos el derecho de suspender o cancelar tu cuenta si se determina que has violado estos términos de uso.</li>
          <li>2.5. Correo Electrónico: Los mensajes de correo electrónico habituales enviados por Internet pueden estar sujetos a posibles intercepciones, pérdidas o alteraciones. De ninguna manera asumimos responsabilidad alguna por ellos, ni tampoco asumimos responsabilidad alguna ante usted u otra persona por daños o problemas de otra índole en relación con mensajes de correo electrónico que usted nos envíe, o envíe a cualquier otro miembro de PocketPal.</li>
        </ul>
        <Typography variant='h5'>Uso adecuado de la Aplicación</Typography>
        <ul>
        ...
        <Typography variant='h5'>Seguridad de tu dinero</Typography>
        <ul>
        ...
        <Typography variant='h5'>Seguridad de tus datos</Typography>
        <ul>
		...
		<Typography variant='h5'>Propiedad Intelectual</Typography>
      	...
      	<Typography variant='h5'>Limitación de Responsabilidad</Typography>
      	<ul>
      	...
      	<Typography variant='h5'>Modificaciones de los Términos de Uso</Typography>
      	<ul>
      	...
      	<Typography variant='h5'>Enlaces Externos</Typography>
      	<ul>
      	...
      	<Typography variant='h5'>Política de cookies</Typography>
      	<p>11.1 En PocketPal utilizamos cookies con el objetivo de prestar un mejor servicio y proporcionarle una mejor experiencia de navegación.</p>
      	...
      	<p>Nosotros somos responsables por la información obtenida de nuestros clientes en el curso normal de las operaciones e información que recibimos on-line de nuestros visitantes que acceden o interactúan en nuestro sitio en la red. Restringimos el acceso a la información sobre Ud. a aquellos empleados que necesiten la información para suministrarle productos o servicios. Mantenemos procedimientos de seguridad física, electrónica y de procedimientos.</p>
      	<Typography variant='h5'>Generalidades</Typography>
      	<ul>
      	...
      	<Typography variant='h5'>Jurisdicción y Ley Aplicable</Typography>
